...
class _MyTabbedPageState extends State<News> with SingleTickerProviderStateMixin {
  ...
  final List<NewsTab> myTabs = <NewsTab>[
    new NewsTab('推荐',new NewsList(newsType: 'shehui')),
    new NewsTab('最热',new NewsList(newsType: 'guonei')),
    new NewsTab('攻略',new NewsList(newsType: 'toutiao')),    //拼音就是参数值
    new NewsTab('求职',new NewsList(newsType: 'guoji')),
    new NewsTab('校讯',new NewsList(newsType: 'yule')),
    new NewsTab('投票',new NewsList(newsType: 'keji')),
    new NewsTab('树洞',new NewsList(newsType: 'caijing')),
    new NewsTab('好物',new NewsList(newsType: 'shishang')),
  ];
    ...
    switch (data.length) {
        ...
        default: {
          return ListView.separated(
            ...
            //如果到了表尾
              if (values[index] == loadingTag) {
                //不足100条，继续获取数据
              if (data.length - 1 < 2100) {
                //获取数据
                loadData();
                print('less');
              //加载时显示loading
 ...
 @override
  ...
  void _retrieveData() {
	...
	"data": [{
		...
		"image_list": [{
			"url": "https://p1.pstatp.com/list/pgc-image/RNFwyPAA0DJJuH"
		}],
		...
		"image_list": [{
			"url": "https://p9.pstatp.com/list/pgc-image/RNFGcLY6AcNA9r"
		}, {
			"url": "https://p1.pstatp.com/list/pgc-image/RNFGcLnI90pzfr"
		}, {
			"url": "https://p1.pstatp.com/list/pgc-image/RNFGcLz4eezmaQ"
		}],
		...
		"media_avatar_url": "//p3.pstatp.com/large/97d001bf3f3cba72913",
		"image_list": [{
			"url": "https://p9.pstatp.com/list/pgc-image/RNFvP9j32ErWk3"
		}, {
			"url": "https://p3.pstatp.com/list/pgc-image/RNFvPA16Qpk2Tj"
		}, {
			"url": "https://p1.pstatp.com/list/pgc-image/RNFvPAEELaPXp6"
		}],
		...
		"media_avatar_url": "//p1.pstatp.com/large/4d00054b126ceaf920",
		"image_list": [{
			"url": "https://p1.pstatp.com/list/pgc-image/RND9JPTDrEWzdV"
		}, {
			"url": "https://p1.pstatp.com/list/pgc-image/RND9JPiIin5nqt"
		}, {
			"url": "https://p1.pstatp.com/list/pgc-image/RND9JPuHbGvYe6"
		}],
		...
		"image_list": [{
			"url": "https://p1.pstatp.com/list/1e06e0000f2390e805d78"
		}, {
			"url": "https://p3.pstatp.com/list/1e0710000f06914e05ebb"
		}, {
			"url": "https://p1.pstatp.com/list/1a09100083efb743a0a68"
		}],
		...
		"media_avatar_url": "//p1.pstatp.com/large/4d00054b126ceaf920",
		"image_list": [{
			"url": "https://p1.pstatp.com/list/pgc-image/RNDyofP7ctwiX3"
		}, {
			"url": "https://p3.pstatp.com/list/pgc-image/RNDyofi2JXE3HQ"
		}, {
			"url": "https://p1.pstatp.com/list/pgc-image/RNDyofv2asevkR"
		}],
		...
		"image_list": [{
			"url": "https://p9.pstatp.com/list/1e07200003c810d43b4f3"
		}, {
			"url": "https://p1.pstatp.com/list/1e07200003c82758cda0b"
		}, {
			"url": "https://p9.pstatp.com/list/1e07300003c413049cc17"
		}],
		...
		"image_list": [{
			"url": "https://p3.pstatp.com/list/pgc-image/RNDIpTY30lPRjV"
		}, {
			"url": "https://p9.pstatp.com/list/pgc-image/RNDIpTq3rb3R1y"
		}, {
			"url": "https://p1.pstatp.com/list/pgc-image/RNDIpU3ESYAkIH"
		}],
		...
		"media_avatar_url": "//p2.pstatp.com/thumb/1398/4664054183",
		"image_list": [{
			"url": "https://p9.pstatp.com/list/pgc-image/RNEgJyH1V0npqk"
		}, {
			"url": "https://p3.pstatp.com/list/pgc-image/RNEgJyc3FUzv4k"
		}, {
			"url": "https://p1.pstatp.com/list/pgc-image/RNEgJz77KDY9Vt"
		}],
		...
		"image_list": [{
			"url": "https://p3.pstatp.com/list/1e0730000e71753fe6042"
		}, {
			"url": "https://p1.pstatp.com/list/1e0700000e43135e4b86c"
		}, {
			"url": "https://p1.pstatp.com/list/1e0670000e7506233ba2a"
		}],
		...
		"media_avatar_url": "//p2.pstatp.com/thumb/1398/4664054183",
		"image_list": [{
			"url": "https://p1.pstatp.com/list/pgc-image/RNFNTMnIqyxHOt"
		}, {
			"url": "https://p1.pstatp.com/list/pgc-image/RNFNTN11XQmQBX"
		}, {
			"url": "https://p3.pstatp.com/list/pgc-image/RNFNTNE2JM8Iwl"
		}],
		...
		"image_list": [{
			"url": "https://p1.pstatp.com/list/pgc-image/RM3oEtMGSrmA0Z"
		}, {
			"url": "https://p1.pstatp.com/list/pgc-image/RM3oEtdCBbeWXi"
		}, {
			"url": "https://p3.pstatp.com/list/pgc-image/RM3oEtqELUgxzl"
		}],
		...
		"media_avatar_url": "//p1.pstatp.com/large/4d00054b126ceaf920",
		"image_list": [{
			"url": "https://p1.pstatp.com/list/pgc-image/RNIExyIEs66wJE"
		}, {
			"url": "https://p9.pstatp.com/list/pgc-image/RNIExyZ8yTHbKp"
		}, {
			"url": "https://p1.pstatp.com/list/pgc-image/RNIExymBgO4ysK"
		}],
...
Widget _newsRow(newsInfo){
  return new GestureDetector (
    onTap: (){
            print(newsInfo);
            Navigator.push(context,new MaterialPageRoute(builder: (context) => new ContentScreen(info: newsInfo)));},
    child:  Card(
      child: new Column(
        children: <Widget>[
          new Container(
            child: new ListTile(title:new Text(newsInfo["title"],textScaleFactor: 1.5,),) ,
            margin: EdgeInsets.fromLTRB(5.0, 5.0, 5.0, 5.0),),
          _generateItem(newsInfo["image_list"]),//根据图片数量返回对应样式的图片
          new Container(
            padding:const EdgeInsets.fromLTRB(25.0, 10.0, 0.0, 10.0),
            child:new Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
                ...
                new Text (newsInfo["comments_count"] == null ? '0' : newsInfo["comments_count"].toString()),
Icon(Icons.comment),
  ...
  //根据获取到的图片数量控制图片的显示样式
  _generateItem(List newsInfos) {
    if(newsInfos == null) {
      return new Text('');
    }
    if(newsInfos.length == 1) {
      return _generateOnePicItem(newsInfos[0]);
    }
     if(newsInfos.length == 3) {
       print('3');
      return _generateThreePicItem(newsInfos);
    }
   }

  //仅有一个图片时的效果
  _generateOnePicItem(Map img){
    return new Row(
      mainAxisSize: MainAxisSize.max,
      children: <Widget>[
        new Expanded(
...
//有三张图片时的效果
  _generateThreePicItem(List imgs){
    return new Row(
      children: <Widget>[
        new Expanded(
            child: new Container(
                padding: const EdgeInsets.all(4.0),
                child: new Image.network(imgs[0]['url'])
            )
        ),
        new Expanded(
            child: new Container(
                padding: const EdgeInsets.all(4.0),
                child: new Image.network(imgs[1]['url'])
            )
        ),
        new Expanded(
            child: new Container(
                padding: const EdgeInsets.all(4.0),
                child: new Image.network(imgs[2]['url'])
            )
        )
      ],
    );
...
class Likes extends StatefulWidget  {
 ...
 @override
  _LikesState createState() => new _LikesState();
}
...
child: Icon(
  ...
  color: status == 'like' ? Colors.red : null,
      ),
   );
  }
}
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      child: new Column(
        children: <Widget>[
          new Container(
            child: new ListTile(title:new Text(info["title"],textScaleFactor: 1.5,),) ,
            margin: EdgeInsets.fromLTRB(5.0, 5.0, 5.0, 5.0),),
